...
!(function (s) {
    ...
    (o = function (s) {
      ...
      (r = {
        ...
        transitionend: function (s, i, e) {
          ...
          s.one(a.transitionend, n),
            s.one(a.webkitTransitionEnd, n),
            setTimeout(n, 1.1 * e);
        },
          ...
          if (l.viewportScale) {
            ...
            "undefined" != typeof s &&
              ...
              l.$body
                ...
                .addClass(
                  o["scale-" + Math.max(Math.min(Math.round(s), 3), 1)]
                ));
          }
        },
      }),
      ...
      l.$body.addClass(s[e].support.touch ? o.touch : o.desktop),
      l.$wndw.on(a.scroll, function (s) {
        l.$body.hasClass(o.opened) &&
          (window.scrollTo(0, l.scrollPosition),
          s.preventDefault(),
          s.stopPropagation(),
      ...
      !l.viewportScale &&
        ...
        r.setViewportScale(),
        l.$wndw.on(a.orientationchange + " " + a.resize, function () {
          l.viewportScaleInterval &&
            (clearTimeout(l.viewportScaleInterval),
            (l.viewportScaleInterval = null)),
  ...
  if (!s[e]) {
    ...
    (s[e] = function (s, i, e) {
      ...
      (s[e].prototype = {
        _init: function () {
          ...
          this._complementOptions(),
            ...
            (this.nodes.$wrpr = s('<div class="' + o.wrapper + '" />')),
            (this.nodes.$sldr = s('<div class="' + o.slider + '" />').appendTo(
              this.nodes.$wrpr
            )),
            this.nodes.$wrpr
              ...
              .on(
                ...
                function (s) {
                  ...
                  var s = arguments.shift(),
                    e = s.type;
                  s.stopPropagation(),
                    "function" == typeof i[e] && i[e].apply(i, arguments);
                }
              )
              .on(
                a.opening +
            ...
            (this.slides.index = 0),
            (this.vars.opened = !0);
          for (var t = 0; t < s[e].addons.length; t++)
            s.isFunction(this["_addon_" + s[e].addons[t]]) &&
              this["_addon_" + s[e].addons[t]]();
          for (var n = 0; n < s[e].ui.length; n++)
            this.nodes.$wrpr.find("." + o[s[e].ui[n]]).length &&
              this.nodes.$wrpr.addClass(o("has-" + s[e].ui[n]));
          "close" == this.opts.wrapper.onClick &&
            this.nodes.$uibg
              .add(this.nodes.$capt || s())
              .add(this.nodes.$pagr || s())
        ...
        open: function (i, e) {
          ...
          this.vars.opened ||
            (this.vars.fixed &&
              ((l.scrollPosition = l.$wndw.scrollTop()),
              l.$body.addClass(o.opened),
              r.setViewportScale()),
            e
              ? this.nodes.$wrpr.addClass(o.opening).trigger(a.opening, [i, e])
              : setTimeout(function () {
            ...
            this._loadContents(),
            s.isNumeric(i) &&
              ((e = e || !this.vars.opened), this.slideTo(i, e));
        },
        close: function (i) {
          this.vars.opened &&
        ...
        prev: function (i, e) {
          s.isNumeric(i) || (i = this.opts.slides.slide),
            this.slideTo(this.slides.index - i, e);
        },
        next: function (i, e) {
          s.isNumeric(i) || (i = this.opts.slides.slide),
            this.slideTo(this.slides.index + i, e);
        ...
        slideTo: function (i, t) {
          ...
          if (i + this.slides.visible > this.slides.total) {
            var l =
              this.slides.index + this.slides.visible >= this.slides.total;
            this.opts.infinite
              ? (i = l ? 0 : this.slides.total - this.slides.visible)
              : ((i = this.slides.total - this.slides.visible), l && (n = !1));
          }
        ...
        _initSlides: function () {
          return (
            this[
              this.$node.is("a")
                ? "_initSlidesFromAnchors"
                : "_initSlidesFromContent"
            ](),
            this.nodes.$sldr
              .children()
              .css(
                ...
                this.opts.slides.width +
                  (this.slides.widthPercentage ? "%" : "px")
              )
          );
        },
        _initSlidesFromAnchors: function () {
          ...
          this.nodes.$anchors.each(function (e) {
            var t = s(this),
              n = s('<div class="' + o.slide + " " + o.loading + '" />')
                .data(d.anchor, t)
        ...
        _initSlidesFromContent: function () {
          ...
          this.$node.children().each(function () {
            ...
            for (var n in s[e].media) {
              ...
              if (
                (i.opts.media[n] &&
                  i.opts.media[n].filterSlides &&
                  (d = i.opts.media[n].filterSlides.call(i, t)),
                "boolean" != typeof d &&
                  (d = s[e].media[n].filterSlides.call(i, t)),
                d)
              ) {
          ...
          switch (this.opts.slides.load) {
            ...
            default:
              this._loadContent(
                ...
                setTimeout(function () {
                  s._loadContent(
                    s.slides.index - s.slides.visible,
                    s.slides.index
                  ),
                    s._loadContent(
                      s.slides.index + s.slides.visible,
                      s.slides.index + 2 * s.slides.visible
                    );
                }, this.conf.transitionDuration);
          }
        },
          ...
          this.nodes.$slides.slice(i, t).each(function () {
            ...
            if (0 == i.children().length) {
              ...
              for (var l in s[e].media) {
                ...
                if (
                  (n.opts.media[l] &&
                    n.opts.media[l].filterAnchors &&
                    (h = n.opts.media[l].filterAnchors.call(n, t)),
                  "boolean" != typeof h &&
                    (h = s[e].media[l].filterAnchors.call(n, t)),
                  h)
                ) {
        ...
        _complementOptions: function () {
          if (
            ("undefined" == typeof this.opts.wrapper.target &&
              (this.opts.wrapper.target = this.$node.is("a")
                ? "window"
                : this.$node),
            "window" != this.opts.wrapper.target &&
              "string" == typeof this.opts.wrapper.target &&
              (this.opts.wrapper.target = s(this.opts.wrapper.target)),
            (this.opts.show = r.complBoolean(
              this.opts.show,
              "window" != this.opts.wrapper.target
            )),
            s.isNumeric(this.opts.slides.width))
          )
            ...
            var i = r.isPercentage(this.opts.slides.width)
            ...
            (this.slides.widthPercentage = !0),
              ...
              (this.opts.slides.width = i
                ? i
                : Math.ceil(1e4 / this.opts.slides.visible) / 100);
          }
        ...
        _uniqueID: function () {
          return (
            ...
            this.__uniqueID++,
            o("uid-" + this.__uniqueID)
          );
        },
      }),
      (s.fn[e] = function (t, n, o, d) {
        l.$wndw || i(),
          (t = s.extend(!0, {}, s[e].defaults, t)),
          (t = s.extend(!0, {}, t, s[e].support.touch ? o : n)),
          (d = s.extend(!0, {}, s[e].configuration, d));
      ...
      (s[e].configuration = { transitionDuration: 400 }),
      (s[e].constants = {}),
      (s[e].debug = function () {}),
      (s[e].deprecated = function (s, i) {
        "undefined" != typeof console &&
          "undefined" != typeof console.warn &&
          console.warn(e + ": " + s + " is deprecated, use " + i + " instead.");
      }),
      (s[e].effects = {
        slide: function (s) {
...
!(function (t) {
  ...
  (t[n].prototype["_addon_" + e] = function () {
    p ||
      ...
      (a = t[n]._f),
      (i = t[n]._g),
      u.add("mouseover mouseout"),
      (p = !0));
    var r = this,
      y = this.opts[e];
    y.play &&
      ((this.opts.infinite = !0),
      this.nodes.$wrpr.on(u.sliding, function () {
        r.autoplay();
      }),
      y.pauseOnHover &&
        this.nodes.$wrpr
          .on(u.mouseover, function () {
            r.autostop();
          })
    ...
    (t[n].defaults[e] = { play: !1, timeout: 4e3, pauseOnHover: !1 }),
    t[n].addons.push(e);
})(jQuery);
/*
 *	jQuery Touch Optimized Sliders "R"Us
...
!(function (s) {
  ...
  (s[l].prototype["_addon_" + r] = function () {
    a ||
      ...
      (d = s[l]._f),
      (p = s[l]._g),
      t.add("prev next close disabled"),
      (a = !0));
    var u = this,
      h = this.opts[r];
    (this.nodes.$prev = null),
      ...
      s.each({ prev: "prev", next: "next", close: "clse" }, function (i, d) {
        h[i] &&
          ("string" == typeof h[i] && "inline" == h[i]
            ? u.vars.fixed &&
              "close" != i &&
              u.nodes.$slides.on(o.loading, function () {
                var o = e(i, " " + t.inline)[
                  "prev" == i ? "prependTo" : "appendTo"
                ](this);
                n(u.nodes.$wrpr, o, i, 1),
                  u.opts.infinite ||
                    ((("prev" == i && s(this).is(":first-child")) ||
                      ("next" == i && s(this).is(":last-child"))) &&
                      o.addClass(t.disabled));
              })
            : ("string" == typeof h[i] && (h[i] = s(h[i])),
              (u.nodes["$" + d] =
                h[i] instanceof s ? h[i] : e(i, "").appendTo(u.nodes.$wrpr)),
              n(u.nodes.$wrpr, u.nodes["$" + d], i, null)));
      }),
      this.opts.infinite ||
        (this.updateButtons(),
  ...
  (t[n].prototype["_addon_" + r] = function () {
    ...
    if (c.add) {
      (c.attributes = c.attributes || []),
        "string" == typeof c.target && (c.target = t(c.target)),
        c.target instanceof t
          ? (this.nodes.$capt = c.target)
          : ((this.nodes.$capt = t(
              '<div class="' + i.caption + '" />'
      ...
      for (var h = 0, l = this.slides.visible; l > h; h++)
        t('<div class="' + i.caption + "-" + h + '" />')
          .css(
            "width",
      ...
      this.nodes.$slides.each(function () {
        ...
        this.nodes.$wrpr.on(a.sliding, function () {
          for (var t = 0, i = p.slides.visible; i > t; t++)
            p.nodes.$capt
              .children()
              .eq(t)
              .text(
...
!(function (e) {
  if ("function" == typeof Hammer) {
    ...
    (e[a].prototype["_addon_" + o] = function () {
          ...
          c.on(
            ...
            .on("panleft panright", function (e) {
              ...
              (("left" == p &&
                ...
                ("right" == p && 0 == l.slides.index)) &&
                (f /= 2.5),
                l.nodes.$sldr.css("margin-left", Math.round(f));
            })
            ...
            .on("panend", function () {
              if (
                (l.nodes.$sldr
                  .removeClass(n.noanimation)
                  .addClass(n.fastanimation),
                i.transitionend(
                  l.nodes.$sldr,
                  function () {
                ...
                e > 0 &&
                  l.nodes.$wrpr.trigger(t["left" == p ? "next" : "prev"], [e]);
              }
              p = !1;
            });
        }
      ...
      (e[a].defaults[o] = e[a].support.touch),
      e[a].addons.push(o);
  }
})(jQuery);
/*
...
!(function (e) {
  ...
  (e[r].prototype["_addon_" + p] = function () {
    ...
    var i = this,
      d = this.opts[p];
    if (
      ("boolean" == typeof d && d && (d = { prev: !0, next: !0, close: !0 }),
      e.isPlainObject(d))
    ) {
      for (var f in e[r].constants[p])
        "boolean" == typeof d[f] && d[f] && (d[f] = e[r].constants[p][f]);
      this.nodes.$slides.length < 2 && ((d.prev = !1), (d.next = !1)),
        e(document).on(n.keyup, function (e) {
          if (i.vars.opened) {
            var t = !1;
            switch (e.keyCode) {
              case d.prev:
            ...
            t &&
              (e.preventDefault(),
              e.stopPropagation(),
              i.nodes.$wrpr.trigger(t));
          }
        });
    }
  }),
    (e[r].defaults[p] = !1),
    (e[r].constants[p] = { prev: 37, next: 39, close: 27 }),
    e[r].addons.push(p);
})(jQuery);
/*
 *	jQuery Touch Optimized Sliders "R"Us
...
!(function (t) {
  ...
  (t[r].prototype["_addon_" + o] = function () {
    d ||
      ...
      (s = t[r]._f),
      (a = t[r]._g),
      e.add("pagination selected uibg bullets thumbnails"),
      (d = !0));
    var u = this,
      l = this.opts[o];
    if ((this.nodes.$slides.length < 2 && (l.add = !1), l.add)) {
      if (
        ("string" == typeof l.target && (l.target = t(l.target)),
        l.target instanceof t
          ? (this.nodes.$pagr = l.target)
          : ((this.nodes.$pagr = t(
              '<div class="' + e.pagination + " " + e[l.type] + '" />'
            ).appendTo(this.nodes.$wrpr)),
            this.nodes.$uibg ||
              (this.nodes.$uibg = t('<div class="' + e.uibg + '" />').prependTo(
                this.nodes.$wrpr
              ))),
        "function" != typeof l.anchorBuilder)
      )
        switch (l.type) {
          case "thumbnails":
            var h = '<a href="#" style="background-image: url(',
              p = ');"></a>';
            l.anchorBuilder = this.vars.fixed
              ? function () {
      ...
      this.nodes.$slides.each(function (e) {
        t(l.anchorBuilder.call(this, e + 1))
          .appendTo(u.nodes.$pagr)
          .on(n.click, function (t) {
            t.preventDefault(),
              t.stopPropagation(),
              u.nodes.$wrpr.trigger(n.slideTo, [e]);
          });
      }),
    ...
    t[r].addons.push(o),
    t[r].ui.push("pagination"),
    t[r].ui.push("bullets"),
    t[r].ui.push("thumbnails");
})(jQuery);
/*
 * jQuery Touch Optimized Sliders "R"Us
 * HTML media
...
!(function (i) {
  ...
  (i[e].media[n] = {
    ...
    initAnchors: function (n, t) {
      i('<div class="' + i[e]._c("html") + '" />')
        .append(i(t))
        .appendTo(n),
        n.removeClass(i[e]._c.loading).trigger(i[e]._e.loaded);
    },
...
!(function (i) {
  ...
  (i[e].media[n] = {
    filterAnchors: function (e) {
      return (
        i.inArray(e.attr("href").toLowerCase().split(".").pop().split("?")[0], [
          "jpg",
          "jpe",
          "jpeg",
          "gif",
...
!(function (i) {
  function t(t) {
    ...
    t
      ...
      .trigger(o.loaded)
      .on(o.loading, function () {
        r.resizeRatio(f, t, g, p, u);
      }),
      this.nodes.$wrpr
        .on(o.sliding, function () {
          l();
        })
  ...
  (i[s].media[d] = {
    ...
    initAnchors: function (a, e) {
      ...
      (e = e.split("vimeo.com/")[1].split("?")[0] + "?api=1&player_id=" + o),
        i(
          '<iframe id="' +
            o +
    ...
    filterSlides: function (i) {
      return i.is("iframe") && i.attr("src")
        ? i.attr("src").toLowerCase().indexOf("vimeo.com/video/") > -1
        : !1;
    },
    ...
    (i[s].defaults.media[d] = {}),
    (i[s].defaults[d] = { ratio: 16 / 9, maxWidth: !1, maxHeight: !1 });
})(jQuery);
/*
 * jQuery Touch Optimized Sliders "R"Us
 * Youtube media
...
!(function (t) {
  function e(e) {
    ...
    c ||
      ...
      (n = t[s]._f),
      (r = t[s]._g),
      o.add("ratio maxWidth maxHeight"),
      (c = !0));
    var l = e.children(),
    ...
    e
      .removeClass(i.loading)
      .trigger(a.loaded)
      .on(a.loading, function () {
        n.resizeRatio(l, e, h, p, f);
      }),
      this.nodes.$wrpr
        .on(a.sliding, function () {
          u("pause");
        })
  ...
  (t[s].media[d] = {
    ...
    initAnchors: function (i, o) {
      var a = o;
      (o = o.split("?v=")[1].split("&")[0]),
        this.opts[d].imageLink
          ? ((o = "http://img.youtube.com/vi/" + o + "/0.jpg"),
            t(
              '<a href="' +
                a +
                '" class="' +
            ...
            t('<img border="0" />')
              .on(t[s]._e.load, function (e) {
                e.stopPropagation(),
                  i.removeClass(t[s]._c.loading).trigger(t[s]._e.loaded);
              })
              .appendTo(i)
              .attr("src", o))
          : (t(
