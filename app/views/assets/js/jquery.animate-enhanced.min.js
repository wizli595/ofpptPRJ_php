...
(function (d, J, K) {
  function P(a, b, d, l, j, h, c, n, q) {
    ...
    n = b.meta;
    for (
      var k = b.original, x = b.properties, Q = b.secondary, D = r.length - 1;
      0 <= D;
      D--
    ) {
      ...
      Q[d] = c
        ? !0 === q || (!0 === G && !1 !== q && L)
          ? "translate3d(" + n.left + "px, " + n.top + "px, 0)"
  ...
  var S = "top right bottom left opacity height width".split(" "),
    ...
    U = /^([+-]=)?([\d+-.]+)(.*)$/,
    V = /([A-Z])/g,
    W = { secondary: {}, meta: { top: 0, right: 0, bottom: 0, left: 0 } },
    N = null,
    C = !1,
  ...
  d.expr &&
    ...
    (d.expr.filters.animated = function (a) {
      return d(a).data("events") &&
        d(a).data("events")["webkitTransitionEnd oTransitionEnd transitionend"]
        ? !0
        : N.call(this, a);
    }));
  d.extend({
  ...
  d.fn.animate = function (a, b, p, l) {
    a = a || {};
    var j = !(
        "undefined" !== typeof a.bottom || "undefined" !== typeof a.right
      ),
      h = d.speed(b, p, l),
      c = this,
      n = 0,
      q = function () {
        n--;
        0 === n &&
          "function" === typeof h.complete &&
          h.complete.apply(c, arguments);
      },
      t;
    if (
      !(t =
        !0 ===
        ("undefined" !== typeof a.avoidCSSTransitions
    ...
    return t
      ...
      : this[!0 === h.queue ? "queue" : "each"](function () {
          var b = d(this),
            c = d.extend({}, h),
            l = function (c) {
              var g = b.data("jQe") || { original: {} },
                f = {};
              if (2 == c.eventPhase) {
                if (!0 !== a.leaveTransforms) {
                  ...
                  if (j && "undefined" !== typeof g.meta) {
                    c = 0;
                    for (var e; (e = I[c]); ++c)
                      (f[e] = g.meta[e + "_o"] + "px"), d(this).css(e, f[e]);
                  }
                }
          ...
          for (e in a)
            if (-1 === d.inArray(e, T)) {
              ...
              if ("d" == u) m = void 0;
                ...
                "top" == u && (s = parseInt(m, 10) + v.y);
                "bottom" == u && (s = parseInt(m, 10) + v.y);
                !f && "show" == w
                  ? ((s = 1),
                    t && g.css({ display: R(g.context.tagName), opacity: 0 }))
                  : !f && "hide" == w && (s = 0);
                f
                  ? ((g = parseFloat(f[2])),
                    f[1] &&
                      (g = ("-=" === f[1] ? -1 : 1) * g + parseInt(s, 10)),
                    (m = g))
                  : (m = s);
              } else m = void 0;
              f = e;
              ...
              if (M(w)) {
                u = -1 < d.inArray(f, S);
                if (
                  ("width" == f || "height" == f || "opacity" == f) &&
                  parseFloat(g) === parseFloat(w.css(f))
                )
                  u = !1;
                f = u;
              } else f = !1;
          ...
          if ((e = b.data("jQe")) && !B(e) && !B(e.secondary)) {
            ...
            var G = e.secondary;
            setTimeout(function () {
              b.bind("webkitTransitionEnd oTransitionEnd transitionend", l).css(
                G
              );
            });
          } else c.queue = !1;
    ...
    this.each(function () {
      ...
      if (j && !B(j)) {
        ...
        if (b) {
          if (
            ((c = j.secondary),
            (!p && void 0 !== typeof j.meta.left_o) ||
              void 0 !== typeof j.meta.top_o)
          ) {
          ...
          if (n)
            for (var q in j.secondary)
              if (
                j.secondary.hasOwnProperty(q) &&
                ((q = q.replace(V, "-$1").toLowerCase()),
                (c[q] = n.getPropertyValue(q)),
                !p && /matrix/i.test(c[q]))
              ) {
                h = c[q].replace(/^matrix\(/i, "").split(/, |\)$/g);
                c.left =
                  parseFloat(h[4]) + parseFloat(l.css("left")) + "px" || "auto";
                c.top =
                  parseFloat(h[5]) + parseFloat(l.css("top")) + "px" || "auto";
                for (h = r.length - 1; 0 <= h; h--) c[r[h] + "transform"] = "";
              }
        }
