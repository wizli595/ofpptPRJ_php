      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul id="top-menu" class="nav navbar-nav navbar-right main-nav">
            ...
            <li class="active"><a href="eventsarchive">Events</a></li>
              ...
              <div class="single_blog_archive wow fadeInUp">
                <div class="blogimg_container">
                  <a href="#" class="blog_img">
                    <img alt="img" src="../app/views/assets/img/blog.jpg">
                  </a>
                </div>
                <h2 class="blog_title"><a href="eventsingle"> Curabitur ac dictum nisl eu hendrerit ante</a>
                </h2>
                ...
                <a class="blog_readmore" href="eventsingle">Read More</a>
              </div>
            </div>
